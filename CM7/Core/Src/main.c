...
/* USER CODE END Boot_Mode_Sequence_2 */
  ...
  GPIO_PinState pin = GPIO_PIN_SET;
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0, pin);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, GPIO_PIN_7|GPIO_PIN_13|GPIO_PIN_0, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PE7 PE13 PE0 */
  GPIO_InitStruct.Pin = GPIO_PIN_7|GPIO_PIN_13|GPIO_PIN_0;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : PC6 PC8 PC10 PC11
                           PC12 */
